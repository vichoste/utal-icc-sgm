...
public class ProfileController : Controller {
	...
	protected async Task<ApplicationUser> CheckApplicationUser() {
	...
	public async Task<IActionResult> Index() {
		if (await this.CheckApplicationUser() is not ApplicationUser applicationUser) {
	...
	public async Task<IActionResult> Student() {
		if (await this.CheckApplicationUser() is not ApplicationUser student) {
			return this.RedirectToAction(nameof(HomeController.Index), nameof(HomeController).Replace("Controller", string.Empty), new { area = string.Empty });
		}
	...
	public async Task<IActionResult> Teacher() {
		if (await this.CheckApplicationUser() is not ApplicationUser teacher) {
			return this.RedirectToAction(nameof(HomeController.Index), nameof(HomeController).Replace("Controller", string.Empty), new { area = string.Empty });
		}
