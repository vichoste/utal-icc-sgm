	...
	public partial class Init : Migration {
		...
		protected override void Up(MigrationBuilder migrationBuilder) {
			...
			_ = migrationBuilder.CreateTable(
				...
				constraints: table => {
					_ = table.PrimaryKey("PK_StudentProposal", x => x.Id);
					_ = table.ForeignKey(
						name: "FK_StudentProposal_AspNetUsers_ApplicationUserId",
			...
			_ = migrationBuilder.CreateIndex(
				name: "IX_StudentProposal_ApplicationUserId",
				table: "StudentProposal",
