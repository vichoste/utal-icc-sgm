...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserMemoir", b =>
                {
                    ...
                    b.Property<string>("AssistingId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("AssistantsId", "AssistingId");

                    b.HasIndex("AssistingId");

                    b.ToTable("ApplicationUserMemoir");
                });

            modelBuilder.Entity("ApplicationUserMemoir1", b =>
                {
                    b.Property<string>("CandidatesId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("CandidaturesId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("CandidatesId", "CandidaturesId");

                    b.HasIndex("CandidaturesId");

                    b.ToTable("ApplicationUserMemoir1");
                });
            ...
            modelBuilder.Entity("Utal.Icc.Sgm.Models.Memoir", b =>
                {
                    ...
                    b.Property<bool>("WasTheCommittee")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ApplicationUserMemoir", b =>
                {
                    ...
                    b.HasOne("Utal.Icc.Sgm.Models.Memoir", null)
                        .WithMany()
                        .HasForeignKey("AssistingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Utal.Icc.Sgm.Models.Memoir", b =>
                {
                    b.HasOne("Utal.Icc.Sgm.Models.ApplicationUser", "Guide")
                        .WithMany("Guiding")
                        .HasForeignKey("GuideId");

                    b.HasOne("Utal.Icc.Sgm.Models.ApplicationUser", "Memorist")
                        .WithMany("Doing")
