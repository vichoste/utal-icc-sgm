...
public partial class NewInit : Migration {
	...
	protected override void Up(MigrationBuilder migrationBuilder) {
		...
		_ = migrationBuilder.CreateTable(
			...
			constraints: table => {
				_ = table.PrimaryKey("PK_StudentProfiles", x => x.Id);
				_ = table.ForeignKey(
					name: "FK_StudentProfiles_AspNetUsers_StudentProfile",
		...
		_ = migrationBuilder.CreateTable(
			...
			constraints: table => {
				_ = table.PrimaryKey("PK_TeacherProfiles", x => x.Id);
				_ = table.ForeignKey(
					name: "FK_TeacherProfiles_AspNetUsers_TeacherProfile",
		...
		_ = migrationBuilder.CreateIndex(
			name: "IX_StudentProfiles_StudentProfile",
		...
		_ = migrationBuilder.CreateIndex(
			name: "IX_TeacherProfiles_TeacherProfile",
